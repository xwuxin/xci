...
$db['slave']['database'] = 'store';
$db['slave']['dbdriver'] = 'mysql';
$db['slave']['dbprefix'] = 'bee_';
$db['slave']['pconnect'] = FALSE;
$db['slave']['db_debug'] = TRUE;
$db['slave']['cache_on'] = FALSE;
$db['slave']['cachedir'] = '';
$db['slave']['char_set'] = 'gbk';
$db['slave']['dbcollat'] = 'gbk_general_ci';
$db['slave']['swap_pre'] = '';
...
$db['master']['database'] = 'store';
$db['master']['dbdriver'] = 'mysql';
$db['master']['dbprefix'] = 'bee_';
$db['master']['pconnect'] = FALSE;
$db['master']['db_debug'] = TRUE;
$db['master']['cache_on'] = FALSE;
$db['master']['cachedir'] = '';
$db['master']['char_set'] = 'gbk';
$db['master']['dbcollat'] = 'gbk_general_ci';
$db['master']['swap_pre'] = '';
