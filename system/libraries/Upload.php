		...
		if ( ! is_uploaded_file($_FILES[$field]['tmp_name']))
		{
			...
			switch($error)
			{
				...
				case 7: // UPLOAD_ERR_CANT_WRITE
					$this->set_error('上传文件写入失败');
					break;
				case 8: // UPLOAD_ERR_EXTENSION
					$this->set_error('upload_stopped_by_extension');
					break;
				default :   $this->set_error('没有选择要上传的文件');
					break;
			}
